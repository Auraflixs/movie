...
function renderHomeView() {
    ...
    // CARGAR EXACTAMENTE 30 ELEMENTOS PARA EL GRID 10x3
    // Si hay menos de 30, se mostrarán los que haya, pero el grid mantendrá las 10 columnas
...
function openModal(id, type) {
    // CORRECCIÓN BÚSQUEDA: Cerrar overlay de búsqueda si está abierto
