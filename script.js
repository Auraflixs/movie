...
async function startDiagnosis(mode) {
    ...
    const BATCH_SIZE = 5; // Verificamos de 5 en 5
    ...
    for (let i = 0; i < total; i += BATCH_SIZE) {
        ...
        // Crear promesas para todo el lote
        // Nota: checkLink no devuelve valor, solo espera. Promise.all espera que todas terminen.
        ...
        status.innerText = `Analizando ${currentCount} de ${total}... (Lotes de ${BATCH_SIZE})`;
