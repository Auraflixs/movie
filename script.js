...
function initApp() {
    ...
    // --- CORRECCIÓN FINAL PARA ORDEN EXACTO ---
    let orderedContent = [];

    // Usamos 'window.globalContent' porque tu HTML ya capturó el orden exacto de los archivos .js
    ...
    // Hacemos reverse() para que el ÚLTIMO archivo cargado (peli21) salga de PRIMERO
...
function setupHero() {
    // Para el Hero usamos todo mezclado para buscar IDs
...
// *** FUNCIÓN MODAL CON LÓGICA DE GÉNEROS ***
function openModal(id, typeHint) {
    ...
    // Determinamos si es serie: si tiene temporadas O si venimos de la vista de series
