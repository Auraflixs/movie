...
// --- FUNCIONES GLOBALES (CRÍTICO: DEBEN ESTAR FUERA DEL DOMContentLoaded) ---
...
function initApp() {
    renderHomeView();
    // Combinar listas para recién agregados
...
// *** FUNCIÓN MODAL CORREGIDA (GÉNEROS LIMITADOS) ***
...
// Navegación (Global para que funcione onclick en HTML)
