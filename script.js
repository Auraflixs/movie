// script.js - Lógica Auraflix+ (Sin título en Hero, sin opciones en Nav, con etiqueta de capítulo)
...
function prevHeroSlide() {
    ...
    // updateHeroText() eliminado porque ya no hay texto en el hero
}
...
// --- REPRODUCTOR CON ETIQUETA DE CAPÍTULO ---
// MODIFICADO: Ahora acepta un segundo parámetro opcional 'overlayText'
function setPlayerVideo(url, overlayText = null) {
    ...
    // NUEVO: Si hay texto para el overlay (es un capítulo), lo agregamos
    if (overlayText) {
...
function renderEpisodes(season, serieItem) {
    ...
    buttons.forEach((btn, index) => {
        btn.onclick = () => {
            ...
            // MODIFICADO: Aquí pasamos el nombre del capítulo al reproductor
...
function setupEventListeners() {
    ...
    // ELIMINADO: Listener del botón de opciones
