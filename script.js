...
function setupEventListeners() {
    ...
    document.getElementById('btnShareAppVersion').onclick = () => shareContent('Auraflix App', 'Descarga Auraflix', 'https://yoldkwlws.github.io/Auraflix2.pk/');
    document.getElementById('btnShareWebVersion').onclick = () => shareContent('Auraflix Web', 'Mira Auraflix', 'https://www.mediafire.com/file/gipq3eknebz7lkn/Auraflix.apk/file');
